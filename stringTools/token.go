...
// GenerateValue returns the email that was stored inside a claim if the token is valid.
func GenerateValue(signedToken string, signingKey []byte) (string, error) {
